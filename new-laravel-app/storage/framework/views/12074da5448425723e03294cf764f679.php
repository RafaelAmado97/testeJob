...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row" id="professor-select" style="display: none;">
                            <label for="professor_id" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Professor')); ?></label>

                            <div class="col-md-6">
                                <select id="professor_id" class="form-control <?php $__errorArgs = ['professor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="professor_id">
                                    <option value=""><?php echo e(__('Select a Professor')); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\coding\freela\testeJob\new-laravel-app\resources\views/auth/register.blade.php ENDPATH**/ ?>